...
const AIChat: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-full relative overflow-hidden">
      ...
      <div className="flex items-center justify-between px-4 py-3 border-b border-indigo-100 bg-white/50 backdrop-blur-sm sticky top-0 z-10">
         <div className="flex items-center gap-2">
           <div className="w-8 h-8 rounded-lg bg-indigo-100 flex items-center justify-center text-indigo-600">
             <Sparkles size={16} />
           </div>
           <div>
               <h3 className="text-sm font-bold text-slate-800">Lumi AI</h3>
      ...
      <div className="flex-1 overflow-hidden relative">
          ...
          <div className="h-full flex flex-col">
                  ...
                  <div className="h-full flex flex-col items-center justify-center text-center p-8 animate-fade-in">
                    ...
                    <div className="mt-6 flex items-start gap-2 max-w-[250px] bg-amber-50 p-3 rounded-lg border border-amber-100/50">
                      ...
                      <p className="text-[11px] text-amber-800 text-left leading-relaxed">
                        Currently, Lumi can only process text. <strong>Image and file uploads</strong> are not supported yet.
                      </p>
                    </div>
                  </div>
                )}
              ...
              {/* INPUT AREA */}
              <div className="p-4 bg-indigo-50/30 border-t border-indigo-100 backdrop-blur-sm z-10">
